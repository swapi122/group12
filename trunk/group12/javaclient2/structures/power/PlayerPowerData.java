 ...
 *
 * $Id: PlayerPowerData.java,v 1.1.1.1 2006/02/15 17:51:18 veedee Exp $
 *
 */
...
//       not exchanging charge with an another device. 
    ...
    /**
     * @return  Status bits. The driver will set the bits to indicate which fields
     *       it is using. Bitwise-and with PLAYER_POWER_MASK_X values to see
     *       which fields are being set.
     **/
    ...
    /**
     * @param newValid  Status bits. The driver will set the bits to indicate which fields
     *       it is using. Bitwise-and with PLAYER_POWER_MASK_X values to see
     *       which fields are being set.
     *
     */
    ...
    /**
     * @param newWatts  estimated current energy consumption (negative values) or
     *       aquisition (positive values) [W]. 
     *
     */
    ...
    /**
     * @param newCharging  charge exchange status: if 1, the device is currently receiving
     *       charge from another energy device. If -1 the device is currently
     *       providing charge to another energy device. If 0, the device is
     *       not exchanging charge with an another device. 
     *
