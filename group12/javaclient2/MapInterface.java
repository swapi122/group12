 ...
 *
 * $Id: MapInterface.java,v 1.5 2006/03/10 19:05:00 veedee Exp $
 *
 */
package javaclient2;
...
public class MapInterface extends PlayerDevice {
    ...
    public void requestMapData (PlayerMapData pmd) {
        try {
        	sendHeader (PLAYER_MSGTYPE_REQ, PLAYER_MAP_REQ_GET_DATA, 20);
            ...
            switch (header.getSubtype ()) {
                ...
                case PLAYER_MAP_REQ_GET_DATA: {
                	...
                	if ((pmdata.getData_count () % 4) != 0)
                		is.readFully (buffer, 0, 4 - (pmdata.getData_count () % 4));
